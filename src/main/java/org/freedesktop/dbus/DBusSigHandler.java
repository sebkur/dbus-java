...
/**
 * Handle a signal on DBus. All Signal handlers are run in their own Thread.
...
public interface DBusSigHandler<T extends DBusSignal>
{
	 ...
	 * 
	 * @param s
	 *            The signal to handle. If such a class exists, the signal will
	 *            be an instance of the class with the correct type signature.
