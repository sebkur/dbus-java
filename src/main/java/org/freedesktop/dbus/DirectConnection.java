...
public class DirectConnection extends AbstractConnection
{
	 ...
	 * 
	 * @param address
	 *            The address to connect to. This is a standard D-Bus address,
	 *            except that the additional parameter 'listen=true' should be
	 *            added in the application which is creating the socket.
	 */
	...
	{
		try {
			DBus.Introspectable intro = (DBus.Introspectable) getRemoteObject(
