...
public class UInt64 extends Number implements Comparable<UInt64>
{
	...
	public static final BigInteger MAX_BIG_VALUE = new BigInteger(
	...
	public UInt64(long value)
	{
		if (value < MIN_VALUE || value > MAX_LONG_VALUE)
			throw new NumberFormatException(
					MessageFormat.format(_("{0} is not between {1} and {2}."),
							new Object[] { value, MIN_VALUE, MAX_LONG_VALUE }));
		this.value = new BigInteger("" + value);
		this.top = this.value.shiftRight(32).and(new BigInteger("4294967295"))
				.longValue();
	 ...
	 * 
	 * @param value
	 *            Must be a valid BigInteger between
	 *            MIN_VALUE&ndash;MAX_BIG_VALUE
	 * @throws NumberFormatException
	 *             if value is not an integer between MIN_VALUE and
	 *             MAX_BIG_VALUE
	 */
	 ...
	 * 
	 * @param value
	 *            Must parse to a valid integer within
	 *            MIN_VALUE&ndash;MAX_BIG_VALUE
	 * @throws NumberFormatException
	 *             if value is not an integer between MIN_VALUE and
	 *             MAX_BIG_VALUE
