...
public interface TestSignalInterface extends DBusInterface
{
	...
	public static class TestArraySignal extends DBusSignal
	{
		...
		public TestArraySignal(String path, List<TestStruct2> v,
				Map<UInt32, TestStruct2> m) throws DBusException
		{
			super(path, v, m);
			this.v = v;
			this.m = m;
	...
	public static class TestObjectSignal extends DBusSignal
	{
		...
		public TestObjectSignal(String path, DBusInterface otherpath)
				throws DBusException
		{
	...
	public static class TestPathSignal extends DBusSignal
	{
		...
		public TestPathSignal(String path, Path otherpath, List<Path> pathlist,
				Map<Path, Path> pathmap) throws DBusException
		{
