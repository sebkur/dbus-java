...
public interface DBus extends DBusInterface
{
	...
	/**
	 * Objects can provide introspection data via this interface and method. See
	 * the <a href=
	 * "http://dbus.freedesktop.org/doc/dbus-specification.html#introspection-format">Introspection
	 * Format</a>.
	 */
	...
	public interface Properties extends DBusInterface
	{
		 ...
		 *            The name of the property.
		 * @param value
		 *            The new value of the property (may be any valid DBus
		 *            type).
		 */
		public <A> void Set(String interface_name, String property_name,
				A value);
	...
	/**
	 * Start a service. If the given service is not provided by any application,
	 * it will be started according to the .service file for that service.
	 * 
	 * @param name
	...
	/**
	 * Add a match rule. Will cause you to receive messages that aren't directed
	 * to you which match this rule.
	 * 
	 * @param matchrule
	...
	/**
	 * Remove a match rule. Will cause you to stop receiving messages that
	 * aren't directed to you which match this rule.
	 * 
	 * @param matchrule
	 *            The Match rule as a string. Format Undocumented.
	 */
	...
	public class NameOwnerChanged extends DBusSignal
	{
		...
		public NameOwnerChanged(String path, String name, String old_owner,
				String new_owner) throws DBusException
		{
	...
	/**
	 * Description of the interface or method, returned in the introspection
	 * data
	 */
	...
	public interface Binding
	{
		...
		public interface TestClient extends DBusInterface
		{
			...
			public static class Trigger extends DBusSignal
			{
				...
				public Trigger(String path, UInt16 a, double b)
		...
		public interface Tests extends DBusInterface
		{
			...
			public Map<String, List<String>> InvertMapping(
					Map<String, String> a);
