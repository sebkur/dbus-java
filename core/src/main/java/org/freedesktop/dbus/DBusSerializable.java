 ...
 * <p>
 * In addition to the serialize method, classes <b>MUST</b> implement a
 * deserialize method which returns null and takes as it's arguments all the
 * DBus types the class will be serialied to <i>in order</i> and <i>with type
 * parameterisation</i>. They <b>MUST</b> also provide a zero-argument
 * constructor.
 * </p>
 * <p>
 ...
 * constructor. This should contain all the code to initialise the object from
 * the types.
 * </p>
 */
