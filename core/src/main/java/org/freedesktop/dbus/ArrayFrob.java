...
class ArrayFrob
{
	...
	@SuppressWarnings("unchecked")
	public static <T> T[] delist(List<T> l, Class<T> c)
			throws IllegalArgumentException
	{
		return l.toArray((T[]) Array.newInstance(c, 0));
	}

	public static <T> Object delistprimitive(List<T> l, Class<T> c)
			throws IllegalArgumentException
	{
	...
	@SuppressWarnings("unchecked")
	public static Object convert(Object o, Class<? extends Object> c)
			throws IllegalArgumentException
	{
		/*
		 * Possible Conversions:
		 *
		 ** List<Integer> -> List<Integer> List<Integer> -> int[] List<Integer>
		 * -> Integer[] int[] -> int[] int[] -> List<Integer> int[] -> Integer[]
		 ** Integer[] -> Integer[] Integer[] -> int[] Integer[] -> List<Integer>
		 */
		try {
		...
		throw new IllegalArgumentException(MessageFormat.format(
				_("Not An Expected Convertion type from {0} to {1}"),
